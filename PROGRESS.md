# Marethar — Translation Progress

Status legend: `[ ]` pending · `[~]` in progress · `[x]` complete · `[R]` needs review
...
| File | Title | Status |
|------|-------|--------|
| `parte0/00_titolo.md` | Title / Front Matter | `[x]` |

---

## Part 1 — Introduction & Systems

| File | Title | Status |
|------|-------|--------|
| `parte1/00_fronte.md` | Part 1 Front Page | `[x]` |
| `parte1/01_intro.md` | Welcome to Marethar | `[x]` |
| `parte1/02_uso.md` | How to Use Marethar in a Campaign | `[x]` |
| `parte1/03_semi.md` | Adventure Seeds | `[x]` |
| `parte1/04_potere.md` | Shades of Power | `[x]` |
| `parte1/05_magia.md` | Magic, Alchemy, and Knowledge | `[x]` |

---

## Part 2 — World Reference

| File | Title | Status |
|------|-------|--------|
| `parte2/00_fronte.md` | Part 2 Front Page | `[x]` |
| `parte2/01_cronologia.md` | Chronology | `[x]` |
| `parte2/02_culture.md` | Cultures — intro | `[x]` |
| `parte2/03_religioni.md` | Religions — intro | `[x]` |
| `parte2/04_geografia.md` | Geography | `[x]` |
| `parte2/05_nazioni.md` | Nations — intro | `[x]` |
| `parte2/06_organizzazioni.md` | Organizations | `[x]` |
| `parte2/07_vitaquotidiana.md` | Daily Life | `[x]` |
...
## Part 3 — Bestiary & Artifacts

| File | Title | Status |
|------|-------|--------|
| `parte3/00_fronte.md` | Part 3 Front Page | `[x]` |
| `parte3/01_bestiario.md` | Bestiary | `[x]` |
| `parte3/02_reliquie.md` | Relics — intro | `[x]` |
| `parte3/03_frammenti.md` | Fragments & Marginalia | `[x]` |
| `parte3/04_domande.md` | Open Questions | `[x]` |
...
## Part 4 — Game Master Tools

| File | Title | Status |
|------|-------|--------|
| `parte4/00_fronte.md` | Part 4 Front Page | `[x]` |
| `parte4/01_come_si_entra.md` | Entry Points | `[x]` |
| `parte4/02_tensioni.md` | Tensions as Plot | `[x]` |
| `parte4/03_ruoli.md` | Roles | `[x]` |
| `parte4/04_materiali.md` | Activating the Materials | `[x]` |
| `parte4/05_avventure.md` | Adventures | `[x]` |

---

## Part 5 — Extended Lore (non-entity)

| File | Title | Status |
|------|-------|--------|
| `parte5/00_fronte.md` | Part 5 Front Page | `[x]` |
| `parte5/04_flora_fauna.md` | Flora & Fauna | `[x]` |
| `parte5/05_cultura.md` | Material Culture | `[x]` |
| `parte5/06_commercio.md` | Trade & Commerce | `[x]` |
| `parte5/07_tecnologia.md` | Technology | `[x]` |
| `parte5/08_personaggi_importanti.md` | Notable Characters | `[x]` |
| `parte5/09_miti.md` | Myths | `[x]` |
...
| File | Title | Status |
|------|-------|--------|
| `parte6/01_tabelle_avventura.md` | Adventure Tables | `[x]` |
...
- Complete: **68 / 68**
- In progress: **0**
- **Translation and atomization complete.**

*Update this table manually after each session, or run `/next` to auto-detect the next pending file.*
