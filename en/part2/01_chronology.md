...
*Shared historical references and interpretive divergences*

> *"The centuries chase one another like armies on the march: orderly only when seen from above."*
> – Linian proverb

Marethar possesses no single shared chronology. Every culture measures time according to its own founding events: some from the first Flood, others from the revelation of a deity, others still from the founding of a sacred city. However, scholars, academies, and chroniclers have over time constructed a **"bridge chronology"**, based on cross-referenced sources, dated objects, astronomical alignments, and agricultural cycles.

This chronology is **imperfect and contested**, but allows the continent's historical development to be read through three principal lenses:

* **Political and military events** (in red)
* **Religious and cultural events** (in gold)
* **Technical, scientific, and magical events** (in blue)

### **The Age of First Faiths**
...
* **Rift between the cities of the Gulf of Ral-Tesh**: Ideological wars between competing cults. *(red/gold)*
* **Discovery of the eastern lands beyond the forbidden routes**: Generation of new syncretic cults and commercial crisis in the islands. *(blue/red)*
* **Explosion in the Fahya laboratory**: Disappearance of three alchemists and opening of a "silent rift" (unconfirmed). *(blue)*
* **Reemergence of the Cult of the Fixed Shadow**: An ancient faith considered extinct reappears with new apocryphal texts. *(gold)*
* **Contradiction**: testimony on the cult's reemergence records conflicting dates spanning more than thirty years. Manipulation of sources is suspected.

### Historiographical Considerations

The elaboration of a common chronology for Marethar is an enterprise as necessary as it is uncertain. Every culture on the continent has over time developed its own **temporal reference system**, rooted in founding events, often mythic, sometimes political, almost never neutral.

**None of these chronologies is complete.**
...
Scholars agree in treating these timelines as **instruments of cultural reading**, useful for understanding how each people perceives its own time, rather than the objective sequence of events that occurred.

> *"Chronologies are mirrors. They reflect what a culture wishes to remember, and what it chooses to forget."*
> — marginal annotation, anonymous manuscript of the School of Fahya
